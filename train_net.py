...
from oneformer.data.dataset_mappers.airbem_semantic_mapper import AirBEMSemanticMapper
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        # coco unified segmentation lsj new baseline
            ...
            return build_detection_train_loader(cfg, mapper=mapper)
        elif cfg.INPUT.DATASET_MAPPER_NAME == "airbem_semantic":
            mapper = AirBEMSemanticMapper(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
        else:
            mapper = None
            return build_detection_train_loader(cfg, mapper=mapper)
